...
export default function MenuPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 md:gap-5 min-h-[calc(100vh-120px)]">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-display font-bold text-lg md:text-xl text-brand-dark truncate">{activeCategoryName}</h2>
          <button
            onClick={handleAdd}
            className="flex items-center gap-2 bg-brand-red hover:bg-brand-red-dark text-white text-sm font-semibold px-3 md:px-4 py-2 md:py-2.5 rounded-xl shadow-btn transition-all active:scale-[0.98] flex-shrink-0"
          >
